...
![LostBrick-Logo](https://github.com/jan-patrick/LostBrick/blob/master/mainimages/fulllogo.jpg)
...
Das Spiel ist auf 16:9 Vollbildmodus konzipiert. Die Steuerung funktioniert über die Pfeiltasten. Dies ist der Code der Universal Windows Platform Version. Zur Originalversion geht es hier: [Original](https://github.com/jan-patrick/LostBrick).

## Downloadanleitung

Über diesen Link ist die aktuellste Version downloadbar:
[Download](https://github.com/jan-patrick/LostBrick/archive/master.zip)
...
![LostBrick-Menu](https://github.com/jan-patrick/LostBrick/blob/master/mainimages/menu.jpg)
...
The game is only playable with screensize 1824x1018 and higher by using full screen mode (or by zooming in or out in your browser) and by using the arrow keys on your keyboard. This is the Universal Windows Platform Version.  You find the original version here: [original](https://github.com/jan-patrick/LostBrick).
